...
export default function StickyProjectCards({ projects }: StickyProjectCardsProps) {
  ...
  // Focus on top 4 premier case studies for desktop "1, 2, 3, 4" scroll progression
  ...
  useGSAP(
    () => {
      ...
      // Only run GSAP ScrollTrigger pinned animation on desktop screens (> 768px)
  ...
  return (
    <div className="sticky-cards-wrapper">
      {/* DESKTOP VIEW: GSAP ScrollTrigger Pinned Stacking Cards */}
      <div className="sticky-cards-desktop sticky-cards-section" ref={containerRef}>
      ...
      {/* MOBILE VIEW: Horizontal Card Slider */}
      <div className="sticky-cards-mobile">
